> [!NOTE]
> Это форк оригинального репозитория **MHSanaei/3x-ui**, созданный в исследовательских целях разработки с помощью ИИ-агента **Codex**.

[Русский](/README.md) | [English (optional)](/README.en_US.md) | [فارسی](/README.fa_IR.md) | [العربية](/README.ar_EG.md) | [中文](/README.zh_CN.md) | [Español](/README.es_ES.md)
